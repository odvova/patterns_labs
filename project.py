...
class Project:
    ...
    def __init__(self, title: str, limit: int, tasks_list: List[Dict], developers: List[Developer]) -> None:
        """Project initializer."""
        self.title = title
    ...
    def add_developer(self, developer: Developer) -> None:
        ...
        try:
            ...
            print("Developer {developer.full_name} exists")
...
class Assignment:
    ...
    """
    def __init__(self, description: str, received_tasks: Dict) -> None:
